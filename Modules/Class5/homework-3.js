...
let sentence7 = 'You are very handsome';
let abbr = '';
let sentenceWords = sentence7.toUpperCase().split(' ');
;
for (let counter = 0 ; counter <= sentenceWords.length-1 ; counter++ ) {
    abbr = abbr + sentenceWords[counter].substring(0,1)
}
console.log(`'\n abbr -> ${abbr}`)
